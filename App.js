$(document).ready(function () {
    ...
    function appendData(field) {
        markup = "<tr ><td ><p><span class='glyphicon glyphicon-user'></span></p></td><td><table id='internalTable'><tr><td id='Name'>" + field.name + "</td></tr><tr><td id = 'UserName'>" + field.username + "</td></tr></table></td><td id='Email' align='right'><a href='userDetails.html?id=" + field.id + "'>" + field.email + "</a></td></tr>";
        tableBody = $("#usersList");
